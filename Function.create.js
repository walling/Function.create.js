...
(function(undefined) {
	...
	if (!Function.create) {
		Function.create = function(name, call, construct, proto) {
			...
			// Convert to string, where null/defined becomes empty string.
			name = '' + [name];
			// Validate function name.
			if (name && !validIdentifier.test(name)) {
				throw new TypeError('Argument name must be a valid JavaScript identifier.');
			}
